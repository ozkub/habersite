...
<head>
    ...
    <title>{{ config('app.name', 'Haberin Sesi') }}</title>
...
<body class="theme-red">
    ...
    <div class="search-bar">
        <div class="search-icon">
            <i class="material-icons">arama</i>
        </div>
        <input type="text" placeholder="Ara...">
        <div class="close-search">
            <i class="material-icons">kapat</i>
        </div>
    </div>
    <!-- #END# Search Bar -->
    <!-- Top Bar -->
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Haberin Sesi - Yönetim Paneli</a>
            </div>
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="javascript:void(0);"><i class="material-icons">person</i>Profilim</a></li>
